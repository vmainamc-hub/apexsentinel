...
const DrawerContent = ({ active_index, is_drawer_open, active_tour, setActiveTabIndex, ...props }: TDrawerContent) => {
    ...
    return <>
        <Tabs active_index={active_index} onTabItemClick={setActiveTabIndex} top>
            ...
            <div id='db-run-panel-tab__transactions' label={<Localize i18n_default_text='Transactions' />}><Transactions is_drawer_open={is_drawer_open} /></div>
            <div id='db-run-panel-tab__journal' label={<Localize i18n_default_text='Journal' />}><Journal /></div>
        </Tabs>
...
const RunPanel = observer(() => {
    ...
    // Keep the panel mounted whenever its owning tab is active. The tour is an overlay/state
    // concern and must not remove the RunPanel itself; doing so leaves tablet/landscape users
    // without the run controls while the tour is being dismissed.
